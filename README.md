Este proyecto consiste en una segmentación de leads, para evaluar la calidad de lo que estamos captando, será un modelo no supervisado donde utilizaremos el algoritmo K-means.
